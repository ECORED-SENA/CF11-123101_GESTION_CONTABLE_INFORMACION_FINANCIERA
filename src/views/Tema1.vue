...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
            ...
            SlyderA(tipo="b")
              .row.justify-content-center.align-items-center.my-lg-4
                .col-lg-7.mb-4.mb-lg-0
                  p #[b La prestación personal del servicio]
                  p El primer elemento de un contrato de trabajo es la prestación personal del servicio por parte del trabajador. #[b “La actividad personal del trabajador, es decir, realizada por sí mismo”], según el CST.
                  p.mb-0 En otras palabras, se podría decir que el trabajador debe realizar el trabajo contratado de forma personalizada, de modo que la ejecución no puede ser delegada a un tercero.
                .col-lg-4
                  figure
              ...
              .row.justify-content-center.align-items-center.my-lg-4
                .col-lg-7.mb-4.mb-lg-0
                  p #[b La retribución o remuneración del servicio]
                  p Por último, se puede afirmar que cuando existe un contrato bilateral y oneroso, se confirma el derecho a una remuneración o pago por realizar una labor.
                  p En cuanto a lo que afirma la norma, esta lo define como: “Un salario como retribución del servicio”. (INCP, s.f.)
                  p Finalmente, para profundizar en los temas propuestos en el CST, se sugiere ingresar a través del siguiente enlace:
                  .row
                    .col-auto
                      a.anexo.mb-4.mb-lg-0(href="http://www.secretariasenado.gov.co/senado/basedoc/codigo_sustantivo_trabajo.html" target="_blank")
                        ...
                        .anexo__texto
                          p #[b Enlace web.] Secretaría del Senado
                .col-lg-4
                  figure
        ...
        .px-5
          ...
          .row.justify-content-center.mb-4(data-aos="fade-down")
            .col-md-6.col-lg-3.mb-4.mb-lg-0
              .p-4.bg-c11
                figure.mb-3
                  img(src='@/assets/curso/tema1/img4.svg', alt='', style="width: 150px").m-auto
            ...
            .col-md-6.col-lg-3.mb-4.mb-lg-0
              .p-4.bg-c11
                figure.mb-3
                  img(src='@/assets/curso/tema1/img5.svg', alt='', style="width: 150px").m-auto
                .row.justify-content-center.mb-3
                  .col-auto.bg-c12
                    .px-2.py-1
            ...
            .col-md-6.col-lg-3.mb-4.mb-md-0
              .p-4.bg-c11
                figure.mb-3
                  img(src='@/assets/curso/tema1/img6.svg', alt='', style="width: 150px").m-auto
                .row.justify-content-center.mb-3
                  .col-auto.bg-c12
                    .px-2.py-1
            ...
            .col-md-6.col-lg-3
              .p-4.bg-c11
                figure.mb-3
                  img(src='@/assets/curso/tema1/img7.svg', alt='', style="width: 150px").m-auto
                .row.justify-content-center.mb-3
                  .col-auto.bg-c12
                    .px-2.py-1
          ...
          .row.justify-content-center.mb-4(data-aos="fade-down")
            ...
            .col-md-6.col-lg-3.mb-4.mb-lg-0
              .p-4.bg-c13
                p.text-center.mb-0 Contrato de dirección, manejo y confianza.
            .col-md-6.col-lg-3.mb-4.mb-lg-0
              .p-4.bg-c13
          ...
          .tarjeta.bg-c6.p-3(data-aos="fade-right")
            .row.justify-content-around.align-items-center
              ...
              .col
                .row.justify-content-between.align-items-center
                  .col.mb-3.mb-sm-0
                    h4.txt-c1.mb-1 Ministerio de Trabajo
                    p.text-white.mb-0 Para fortalecer la comprensión de los conceptos, es importante revisar el siguiente contenido web, el cual presenta y explica los fundamentos normativos.
                  .col-sm-auto
                    a.boton.color-acento-botones(href="https://www.mintrabajo.gov.co/normatividad/leyes-y-decretos-ley/codigos" target="_blank")
                      span(style="color: #12263F") Ir al sitio web
                      i.fas.fa-link(style="color: #12263F")
    .row
      .col-12
          ...
          .tarjeta.tarjeta--azul1.p-4(data-aos="fade-down")
            SlyderA(tipo="b")
              .row.justify-content-center.align-items-center.my-lg-4
                ...
                .col-lg-4
                  figure
                    img(src="@/assets/curso/tema1/img18.png", alt="", style="width: 400px").m-auto
              .row.justify-content-center.align-items-center.my-lg-4
                .col-lg-7.mb-4.mb-lg-0
                  ul.lista-ul--color.mb-0
                    li.d-flex
    ...
    #t_1_4
    .titulo-segundo.color-acento-contenido
      h2 1.4 Causales de terminación del contrato de trabajo e indemnizaciones
    .row.mb-4.ms-0
      .col-auto.bg-c8(data-aos="fade-left")
        .row.align-items-center
          .col-auto.px-0
